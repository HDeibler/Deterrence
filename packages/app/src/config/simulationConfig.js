...
export const simulationConfig = {
  ...
  missile: {
    actualPathSampleSeconds: 3,
    actualPathPoints: 1200,
    predictedPathPoints: 600,
    predictionSampleSeconds: 8,
    predictionRefreshSeconds: 1.0,
    maxFlightSeconds: 5400,
    maxIntegrationStepSeconds: 0.2,
